 ...
 */
class getCarrièreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CarrièreRepository' shared autowired service.
     *
     * @return \App\Repository\CarrièreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CarrièreRepository.php';

        return $container->privates['App\\Repository\\CarrièreRepository'] = new \App\Repository\CarrièreRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
