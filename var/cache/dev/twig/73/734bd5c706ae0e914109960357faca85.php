...
/* baseFront.html.twig */
class __TwigTemplate_19966a3718e6e2d2f107145e038a9eba extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t<h2 class=\"heading aos-init aos-animate\" data-aos=\"fade-up\" data-aos-duration=\"1500\">Les Meilleurs Bâtisseurs pour Concrétiser votre Projet de Rêve</h2>
\t\t\t\t\t\t\t\t\t<p class=\"desc aos-init aos-animate\" data-aos=\"fade-up\" data-aos-duration=\"2000\">Une entreprise de construction sûre, fiable et rentable. Nous offrons les meilleurs services de construction.</p>
\t\t\t\t\t\t\t\t\t<div class=\"slider_button aos-init aos-animate\" data-aos=\"fade-right\" data-aos-duration=\"2500\">
\t\t\t\t\t\t\t\t\t\t<a href=\"about.html\" class=\"button\">Savoir Plus
\t\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t<h1 class=\"section_title\">Bâtir une Nouvelle Ère dans le Monde de la Construction</h1>
\t\t\t\t\t\t\t\t\t<h6 class=\"section_sub_title\">La Société des Travaux Modernes (S.TRA.M)</h6>
\t\t\t\t\t\t\t\t\t<p class=\"section_desc\">Créée en 2007, l’activité de  STRAM s’est basée sur la conception et la rénovation des travaux d’aménagement commerciaux, résidentiels et industriels.
...
\t\t\t\t\t\t<h1 class=\"section_title\">Les projets populaires</h1>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"row g-0\">
\t\t\t\t\t\t<div class=\"col\">
...
\t\t\t\t\t\t<p class=\"section_desc\">STRAM est la meilleure entreprise de construction. Il a la meilleure équipe qui fournit le meilleur service possible..</p>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t<div class=\"col-12\">
...
\t\t\t\t\t\t\t\t\t<h1 class=\"section_title\">Nos dernières nouvelles</h1>
\t\t\t\t\t\t\t\t\t<p class=\"section_desc\">STRAM est la meilleure entreprise de construction. Il a la meilleure équipe qui fournit le meilleur service possible.</p>
\t\t\t\t\t\t\t\t</div>
...
<script src=\"js/funfacts.js\"></script>
<script src=\"js/custom.js\"></script></body></html>
", "baseFront.html.twig", "C:\\Users\\anest\\OneDrive\\Bureau\\Stram_WebSite\\templates\\baseFront.html.twig");
    }
}
